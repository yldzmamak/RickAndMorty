...
export const loginUserService = async (request: ILogin) => {
  ...
  if (isLocal) {
    ...
    LOGIN_API_ENDPOINT = `https://64c243a9473007000860b25b--fastidious-bombolone-a9ae5a.netlify.app/.netlify/functions/json-server/users?username=${request.CLIENT_USERNAME}&password=${request.CLIENT_PASSWORD}`;
  }

  const parameters = {
    method: "GET",
    headers: {
      "Access-Control-Allow-Origin": "https://64c243a9473007000860b25b--fastidious-bombolone-a9ae5a.netlify.app",
