...
export const loginUserService = async (request: ILogin) => {
  ...
  if (isLocal) {
    ...
    LOGIN_API_ENDPOINT = `https://fastidious-bombolone-a9ae5a.netlify.app:3000/.netlify/functions/json-server/users?username=${request.CLIENT_USERNAME}&password=${request.CLIENT_PASSWORD}`;
  }
